package cn.onestravel.library.common.adapter
...
import cn.onestravel.library.common.extend.loadImage
import cn.onestravel.library.common.one.R
...
/**
 * @name OneRecyclerAdapter
 * @description 所有RecyclerView 的Adapter 的基类
 * @createTime 2018/11/29 14:32
 * @author onestravel
 * @version 1.0.0
 */
abstract class OneRecyclerAdapter<T> : RecyclerView.Adapter<VH>(), View.OnClickListener,
