package cn.onestravel.library.kotlin.one.adapter
...
import cn.onestravel.library.kotlin.one.extend.loadImage
 ...
 * @version 1.0.0
 */
abstract class OneRecyclerAdapter<T> : RecyclerView.Adapter<VH>(), View.OnClickListener, View.OnLongClickListener {
