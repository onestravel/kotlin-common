...
import cn.onestravel.library.kotlin.one.activity.OneListActivity
...
/**
 * @name OneRxListActivity
 * @description 处理RXJava的生命周期的ListActivity
 * @createTime 2018/12/12 17:00
 * @author onestravel
 * @version 1.0.0
 */
abstract class OneRxListActivity : OneListActivity(), LifecycleProvider<ActivityEvent> {
