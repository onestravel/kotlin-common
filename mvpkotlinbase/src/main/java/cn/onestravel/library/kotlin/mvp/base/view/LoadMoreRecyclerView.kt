...
/**
 * @name cn.onestravel.library.kotlin.mvp.base.view.LoadMoreRecyclerView
 * @description //TODO
 * @createTime 2018/11/29 17:53
 * @author onestravel
 * @version 1.0.0
 */
class LoadMoreRecyclerView(context: Context, attrs: AttributeSet?, defStyle: Int) : RecyclerView(context, attrs, defStyle) {
